...
application_objects: build/servo_driver.o build/leg_driver_base.o build/leg_driver_02.o build/leg_driver_13.o build/sleep.o build/robot.o build/builder.o
...
build/sleep.o: src/sleep/sleep.cpp
	g++ -c -std=c++14 src/sleep/sleep.cpp -o build/sleep.o
...
test_leg:
	g++ -std=c++14 build/servo_driver.o build/leg_driver_base.o build/leg_driver_02.o build/leg_driver_13.o build/test_leg.o -o bin/test_leg -lwiringPi -pthread

unit_tests:
	g++ -std=c++14 build/leg_driver_base.o build/leg_driver_02.o build/leg_driver_13.o build/leg_unit_tests.o build/sleep.o build/robot.o build/robot_unit_tests.o build/unit_tests.o -o bin/unit_tests

charlotte:
	g++ -std=c++14 build/servo_driver.o build/leg_driver_base.o build/leg_driver_02.o build/leg_driver_13.o build/sleep.o build/robot.o build/builder.o build/charlotte.o -o bin/charlottei -lwiringPi -pthread
