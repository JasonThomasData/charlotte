...
TEST_CASE("LegDriver_02 - move up")
{
    ...
    Fake(Dtor(bottom_servo));
    Fake(Dtor(middle_servo));
    Fake(Dtor(top_servo));
    ...
    std::unique_ptr<IServoDriver> bottom_servo_unique_ptr(bottom_servo_ptr);
    std::unique_ptr<IServoDriver> middle_servo_unique_ptr(middle_servo_ptr);
    std::unique_ptr<IServoDriver> top_servo_unique_ptr(top_servo_ptr);


    LegDriver_02 leg = LegDriver_02(std::move(bottom_servo_unique_ptr),
                                    std::move(middle_servo_unique_ptr),
                                    std::move(top_servo_unique_ptr));
...
TEST_CASE("LegDriver_02 - move down")
{
    ...
    LegDriver_02 leg = LegDriver_02(bottom_servo_unique_ptr,
                                    middle_servo_unique_ptr,
                                    top_servo_unique_ptr);
